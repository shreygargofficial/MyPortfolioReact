...
function Bio() {
  ...
  <section className={css(BioStyle.main)}>
    <section className={css(BioStyle.flexContainer)}>
      <article className={css(BioStyle.flexedImage)} data-aos="fade-right"  data-aos-delay="100">
        <img src="images/shreyMobile.jpeg" alt="shrey" style={{width:'50%',display:'block',margin:'0 auto'}}/>
      </article>
      <article className={css(BioStyle.flexedText)}  data-aos="fade-left" data-aos-duration="1000" data-aos-delay="200">
