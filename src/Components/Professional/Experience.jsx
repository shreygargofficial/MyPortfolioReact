...
function Experience() {
    ...
    return ( 
        ...
        <section className={iphoneContextConsumer.isIphone ? css(ExperienceStyle.banner,main.attachmentS):  css(ExperienceStyle.banner)}>
            <h2 className={css(main.heading)}>Experience</h2>
            <article className={css(ExperienceStyle.article)}>
                <section className={css(ExperienceStyle.articleSection)}  data-aos="zoom-in" data-aos-delay="100">
                    <div className={css(ExperienceStyle.articleSectionImg)}>
                        <img src="images/mindera.png" alt="Mindera" style={{width:'100%'}}/>
                    </div>
                    <div className={css(ExperienceStyle.articleSectionContent)}>
                ...
                <section className={css(ExperienceStyle.articleSection,ExperienceStyle.orderReverse)}  data-aos="zoom-in"  data-aos-delay="200">
                <div className={css(ExperienceStyle.articleSectionImg)}>
                    <img src="images/infosys.png" alt="Infosys" style={{width:'100%'}}/>
                </div>
                <div className={css(ExperienceStyle.articleSectionContent)}>
